...
#   2.必要なソース一部だけをパッケージ作成に必要なフォルダにコピー
...
cd ..
# ============================================
# 必要なソース一部だけをパッケージ作成に必要なフォルダにコピー
rm -rf force-app/main/UnofficialSF/
mkdir force-app/main/UnofficialSF/
mkdir force-app/main/UnofficialSF/FlowActionsBasePack/
mkdir force-app/main/UnofficialSF/FlowActionsBasePack/classes/
mkdir force-app/main/UnofficialSF/FlowScreenComponentsBasePack/
mkdir force-app/main/UnofficialSF/FlowScreenComponentsBasePack/labels/
mkdir force-app/main/UnofficialSF/FlowScreenComponentsBasePack/lwc/

### ■ LICENSE
COPY_SOURCE=tmp_clone_dir/LightningFlowComponents/LICENSE
COPY_TARGET=force-app/main/UnofficialSF/LICENSE
...
COPY_TARGET=force-app/main/UnofficialSF/FlowActionsBasePack/classes/FieldPickerController.cls
cp $COPY_SOURCE $COPY_TARGET
...
COPY_TARGET=force-app/main/UnofficialSF/FlowActionsBasePack/classes/FieldPickerController.cls-meta.xml
cp $COPY_SOURCE $COPY_TARGET
...
COPY_TARGET=force-app/main/UnofficialSF/FlowActionsBasePack/classes/FieldPickerControllerTest.cls
cp $COPY_SOURCE $COPY_TARGET
...
COPY_TARGET=force-app/main/UnofficialSF/FlowActionsBasePack/classes/FieldPickerControllerTest.cls-meta.xml
cp $COPY_SOURCE $COPY_TARGET
...
COPY_TARGET=force-app/main/UnofficialSF/FlowActionsBasePack/classes/FieldSelectorController.cls
cp $COPY_SOURCE $COPY_TARGET
...
COPY_TARGET=force-app/main/UnofficialSF/FlowActionsBasePack/classes/FieldSelectorController.cls-meta.xml
cp $COPY_SOURCE $COPY_TARGET
...
COPY_TARGET=force-app/main/UnofficialSF/FlowActionsBasePack/classes/FieldSelectorControllerTest.cls
cp $COPY_SOURCE $COPY_TARGET
...
COPY_TARGET=force-app/main/UnofficialSF/FlowActionsBasePack/classes/FieldSelectorControllerTest.cls-meta.xml
cp $COPY_SOURCE $COPY_TARGET
### ■ CustomLabels
mkdir force-app/main/UnofficialSF/FlowScreenComponentsBasePack/labels
...
COPY_TARGET=force-app/main/UnofficialSF/FlowScreenComponentsBasePack/labels/CustomLabels.labels-meta.xml
cp $COPY_SOURCE $COPY_TARGET
### ■ fsc_fieldSelector
...
mkdir force-app/main/UnofficialSF/FlowScreenComponentsBasePack/lwc/fsc_fieldSelector
...
COPY_TARGET=force-app/main/UnofficialSF/FlowScreenComponentsBasePack/lwc
...
mkdir force-app/main/UnofficialSF/FlowScreenComponentsBasePack/lwc/fsc_flowCombobox
...
mkdir force-app/main/UnofficialSF/FlowScreenComponentsBasePack/lwc/fsc_flowComboboxUtils
...
mkdir force-app/main/UnofficialSF/FlowScreenComponentsBasePack/lwc/fsc_pickObjectAndField
...
mkdir force-app/main/UnofficialSF/FlowScreenComponentsBasePack/lwc/fsc_pickObjectAndFieldUtils
...
### force-app/main/UnofficialSF/FlowScreenComponentsBasePack/lwc/fsc_fieldSelector/fsc_fieldSelector.js
#### 名前空間「usf」の除外
...
REPLACE_TARGET=force-app/main/UnofficialSF/FlowScreenComponentsBasePack/lwc/fsc_fieldSelector/fsc_fieldSelector.js
...
### force-app/main/UnofficialSF/FlowScreenComponentsBasePack/lwc/fsc_pickObjectAndField/fsc_pickObjectAndField.js
#### 名前空間「usf」の除外
...
REPLACE_TARGET=force-app/main/UnofficialSF/FlowScreenComponentsBasePack/lwc/fsc_pickObjectAndField/fsc_pickObjectAndField.js
sed -i.bak -e 's/usf.FieldPickerController.getObjects/FieldPickerController.getObjects/g' $REPLACE_TARGET
rm "$REPLACE_TARGET.bak"
### force-app/main/UnofficialSF/FlowScreenComponentsBasePack/lwc/fsc_pickObjectAndField/fsc_pickObjectAndField.js-meta.xml
#### 展開モードを除外
###### <isExposed>true</isExposed>
######     ↓
###### <isExposed>false</isExposed>
REPLACE_TARGET=force-app/main/UnofficialSF/FlowScreenComponentsBasePack/lwc/fsc_pickObjectAndField/fsc_pickObjectAndField.js-meta.xml
